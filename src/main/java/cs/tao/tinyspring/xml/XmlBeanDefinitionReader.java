package cs.tao.tinyspring.xml;

import cs.tao.tinyspring.AbstractBeanDefinitionReader;
...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
    ...
    public void loadBeanDefinitions(String configLocation) throws Exception {
        InputStream inputStream = getResourceLoader().getResource(configLocation).getInputStream();
